...
void dgx_vscreen_to_screen(dgx_screen_t *scr_dst, int16_t x_dst, int16_t y_dst, dgx_screen_t *scr_src) {
    int16_t x1 = x_dst, y1 = y_dst, bw = scr_src->width, bh = scr_src->height;
...
void dgx_vscreen_to_vscreen(dgx_screen_t *scr_dst, int16_t x_dst, int16_t y_dst, dgx_screen_t *scr_src,
        dgx_bitblt_rop_t rop) {
    int16_t x1 = x_dst, y1 = y_dst, bw = scr_src->width, bh = scr_src->height;
    int16_t skip_x = 0, skip_y = 0;
    if (x1 < 0) {
        skip_x = -x1;
...
void dgx_copy_region_from_vscreen(dgx_screen_t *scr_dst, int16_t x_dst, int16_t y_dst, dgx_screen_t *scr_src,
        int16_t x_src, int16_t y_src, int16_t width, int16_t height, uint32_t outer_color) {
    int16_t x1 = x_dst, y1 = y_dst, bw = width, bh = height;
    int16_t skip_x = 0, skip_y = 0;
    if (x1 < 0) {
        skip_x = -x1;
        bw += x1;
